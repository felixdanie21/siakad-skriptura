    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-sm-7 mx-auto">
                <a href="<?= base_url() ?>Akademik/Matakuliah/Komponenpnl/form" class="btn btn-primary mb-2">TAMBAH <i class="fas fa-plus"></i></a>
                    ...
                    <tbody>
                        <?php if($table):?>
                            <?php foreach($table as $t):?>
                                <tr>
                                    <td class="text-center"><?= $t['kodepenilaian'] ?></td>
                                    <td class="text-left"><?= $t['namapenilaian'] ?></td>
                                    <td class="text-left">
                                        <a href="<?= base_url() ?>Akademik/Matakuliah/Komponenpnl/form?kodepenilaian=<?= $t['kodepenilaian'] ?>" class="btn btn-sm btn-secondary"><i class="fas fa-edit"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else:?>
